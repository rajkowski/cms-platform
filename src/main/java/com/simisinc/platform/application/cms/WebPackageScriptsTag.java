...
/**
 * Outputs all of the common scripts specified within widgets
 *
 * @author matt rajkowski
 * @created 11/3/24 5:15 PM
 */
public class WebPackageScriptsTag extends SimpleTagSupport {

  private static Log LOG = LogFactory.getLog(WebPackageScriptsTag.class);
  ...
  public void doTag() throws JspException, IOException {
    ...
    // Iterate the Scripts and output them... this allows them to be in the head, and removes duplication
