 ...
 */
public class CalendarsListJsonService extends GenericWidget {
    ...
    try {
      ...
      if (calendars != null && !calendars.isEmpty()) {
        ...
        for (Calendar calendar : calendars) {
          ...
          json.append("\"description\": \"").append(JsonCommand.toJson(StringUtils.defaultString(calendar.getDescription()))).append("\"");
          json.append("}");
        }
      }
