...
/**
 * Syncs a dataset to a collection for the visual data editor
 *
 * @author matt rajkowski
 * @created 01/25/26 5:00 PM
 */
public class DatasetSyncAjax extends GenericWidget {
  ...
  public WidgetContext post(WidgetContext context) {
    ...
    if (!context.hasRole("admin") && !context.hasRole("data-manager")) {
      LOG.debug("No permission to sync dataset");
    ...
    context.setJson("{\"success\":true,\"message\":\"Dataset sync not yet implemented\"}");
    return context;
  }
}
