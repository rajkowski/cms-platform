...
/**
 * Displays information about the current webpage
 *
 * @author matt rajkowski
 * @created 7/24/26 8:00 AM
 */
public class PageSummaryWidget extends GenericWidget {

  static final long serialVersionUID = -8484048371911908893L;

  protected static Log LOG = LogFactory.getLog(PageSummaryWidget.class);

  static String JSP = "/cms/page-summary.jsp";
