 ...
 */
package com.zeroio.platform.application.staticsite;
...
import com.simisinc.platform.application.cms.WebPageMetadataCommand;
...
public class MakeStaticSiteCommand {
  ...
  private static String exportContent(File webAppPath, File sitePath, File fileLibraryPath) throws Exception {
    ...
    String serverModulePath = FileSystemCommand.generateFileServerSubPath(FileModulesConstants.STATIC_SITES);
    File zipFile = FileSystemCommand.generateTempFile(FileModulesConstants.STATIC_SITES, "static-site-", -1, "zip");
    String exportedFile = serverModulePath + zipFile.getName();
