 ...
 */
public class FileItemDocumentContentCommand {

  private static Log LOG = LogFactory.getLog(FileItemDocumentContentCommand.class);

  /**
   * Updates the text index for the given file item
   *
   * @param fileItem the file item
   * @return true if successful, false otherwise
   */
  public static boolean updateTextIndex(FileItem fileItem) {
    if (fileItem == null) {
      return false;
    }
