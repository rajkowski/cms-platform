    ...
    if (pagesContainer) {
      if (data.topPages && data.topPages.length > 0) {
        ...
        data.topPages.forEach(page => {
          ...
          const uniqueSystemUsers = page.uniqueSystemUsers || page.unique_system_users || 0;
          ...
          row.innerHTML = `
            ...
            <td>${formatNumber(uniqueSystemUsers)}</td>
        ...
        pagesContainer.innerHTML = '<tr><td colspan="6" class="text-muted text-center">No top pages available</td></tr>';
      }
    }
