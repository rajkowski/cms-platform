...
import com.simisinc.platform.application.datasets.DatasetFieldOptionCommand;
...
class DatasetFieldOptionCommandTest {
  ...
  void testURL() {
    ...
    Assertions.assertEquals("https://www.simiscms.com",
        DatasetFieldOptionCommand.applyOptionsToField("validateUrl", "https://www.simiscms.com"));
  }
