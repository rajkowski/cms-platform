...
class UrlCommandTest {
  ...
  @Test
  void isUriValid() {
    Assertions.assertTrue(UrlCommand.isUriValid("/page"));
    Assertions.assertTrue(UrlCommand.isUriValid("/page?name=value"));
    Assertions.assertTrue(UrlCommand.isUriValid("http://www.example.com"));
    Assertions.assertTrue(UrlCommand.isUriValid("http://example.com"));
    Assertions.assertTrue(UrlCommand.isUriValid("http://example.com?name=value"));
    Assertions.assertTrue(UrlCommand.isUriValid("http://example.com?name=value&name1=value1"));
    Assertions.assertFalse(UrlCommand.isUriValid("http://example.com?\"name=value\""));
    Assertions.assertFalse(UrlCommand.isUriValid("http://example.com?name=\"value\""));
    Assertions.assertFalse(UrlCommand.isUriValid("http://example.com "));
  }
